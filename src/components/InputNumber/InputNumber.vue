...
const prefixCls = 'asa-input-number';
...
<template>
  <div :class="wrapClasses">
    <template v-if="controlsOutside">
      <div
        class="el-input-number--default is-controls-right el-input-number--default is-controls-right"
        :class="{ 'el-input-number--default is-controls-right': downDisabled }"
        @mousedown="minus"
      ...
      <div
        class="el-input-number--default is-controls-right el-input-number--default is-controls-right"
        :class="{ 'el-input-number--default is-controls-right': upDisabled }"
        @mousedown="plus"
        v-bind="clearRepeatTimerProps"
      >
        2
    ...
    <div :class="handlerClasses" v-else-if="!hideButton">
      <a :class="upClasses" @mousedown="plus" v-bind="clearRepeatTimerProps">
        <span>
          <el-icon size="12px" color="#999"><ArrowUp /></el-icon>
        </span>
      </a>
      <a :class="downClasses" @mousedown="minus" v-bind="clearRepeatTimerProps">
        <span>
          <el-icon size="12px" color="#999"><ArrowDown /></el-icon>
        </span>
      </a>
    </div>
...
$input-number-prefix-cls: 'asa-input-number';
